...
export default function Services() {
  const services = [
    ...
    },
    {
      ...
      icon: (
        <svg className="w-7 h-8 text-red-600" fill="currentColor" viewBox="0 0 16 16">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-8 h-8 text-red-600" fill="currentColor" viewBox="0 0 16 18">
  ...
  return (
    <section className="py-24 bg-white" id="servicios">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <motion.span variants={itemVariants} className="text-sm font-semibold text-red-600 uppercase tracking-widest block">
            Soluciones Tecnológicas
          </motion.span>
          <motion.h2 variants={itemVariants} className="mt-2 text-4xl font-extrabold text-slate-900 tracking-tight sm:text-5xl">
            ¿Qué Ofrecemos?
          </motion.h2>
          <motion.p variants={itemVariants} className="mt-5 text-xl text-gray-600 leading-relaxed">
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="relative group p-8 bg-white border border-gray-100 rounded-3xl transition-shadow duration-300 hover:border-red-100 hover:shadow-2xl hover:shadow-red-500/10"
            >
              ...
              <div className="relative z-10">
                <motion.div 
                  ...
                  className="w-16 h-16 bg-red-50 rounded-2xl flex items-center justify-center mb-8 border border-red-100"
                >
                  {service.icon}
                </motion.div>
